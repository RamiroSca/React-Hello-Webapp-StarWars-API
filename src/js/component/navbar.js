	...
	return (
		<nav className="container navbar navbar-light bg-white mb-3">
			...
			<div className="btn-group" role="group">
				<button id="btnGroupDrop1" type="button" className="btn btn-primary dropdown-toggle mx-2" data-bs-toggle="dropdown" aria-expanded="false">
					<strong>Iniciar secion/Registarse</strong>
				</button>
				<ul className="dropdown-menu justify-content-center" aria-labelledby="btnGroupDrop1">
